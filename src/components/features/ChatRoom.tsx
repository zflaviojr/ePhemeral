  ...
  return (
    <div className={`chat-container ${isLeaving ? 'animate-leave' : ''}`}>
      ...
      <style>{`
        ...
        .chat-header { display: flex; align-items: center; padding: 12px 15px; gap: 10px; z-index: 100; color: white; background: rgba(138, 136, 251, 0.4); backdrop-filter: blur(12px); border-bottom: 1px solid rgba(255,255,255,0.1); flex-shrink: 0; }
        .rounded-header { border-bottom-left-radius: 25px; border-bottom-right-radius: 25px; margin: 0 4px; }
        .shadow-glow { box-shadow: 0 8px 32px rgba(0,0,0,0.15); }
        .header-btn { background: none; border: none; color: white; cursor: pointer; display: flex; align-items: center; padding: 6px; border-radius: 50%; }
        
        .room-info-header { flex: 1; min-width: 0; }
        .room-info-header h2 { margin: 0; font-size: 1rem; font-weight: 800; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .room-meta { display: flex; align-items: center; gap: 6px; }
        .room-type-tag { font-size: 0.55rem; background: rgba(255,255,255,0.2); padding: 1px 6px; border-radius: 6px; font-weight: 700; text-transform: uppercase; }
        .creator-header-tag { font-size: 0.6rem; color: rgba(255,255,255,0.8); font-style: italic; }
        ...
        .members-sidebar { width: 65px; background: rgba(255, 255, 255, 0.08); border-top-right-radius: 25px; border-bottom-right-radius: 25px; margin: 5px 8px 5px 0; transition: width 0.3s; display: flex; flex-direction: column; align-items: center; padding: 12px 0; backdrop-filter: blur(20px); border: 1px solid rgba(255,255,255,0.1); border-left: none; flex-shrink: 0; }
        .members-sidebar.closed { width: 0; padding: 0; margin: 0; overflow: hidden; opacity: 0; }
        
        .sidebar-scroll { display: flex; flex-direction: column; gap: 10px; overflow-y: auto; padding: 0 8px; scrollbar-width: none; height: 100%; }
        .member-avatar { width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 800; flex-shrink: 0; color: var(--primary-dark); background: white; border: 2px solid rgba(255,255,255,0.5); font-size: 0.9rem; }
        
        .chat-messages-area { flex: 1; padding: 10px; overflow-y: auto; display: flex; flex-direction: column; gap: 12px; min-width: 0; }
        
        .ephemeral-alert-pill { align-self: center; background: rgba(0,0,0,0.2); color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.65rem; display: flex; align-items: center; gap: 6px; margin-bottom: 5px; }
        ...
        .msg-sender { font-size: 0.65rem; color: rgba(255,255,255,0.9); margin: 0 0 2px 6px; font-weight: 700; }
        .msg-bubble { background: white; color: #333; padding: 8px 12px; border-radius: 15px; border-bottom-left-radius: 4px; line-height: 1.4; font-size: 0.9rem; }
        .msg-own .msg-bubble { background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-dark) 100%); color: white; border-bottom-left-radius: 15px; border-bottom-right-radius: 4px; }
        
        .msg-time { font-size: 0.55rem; color: rgba(0,0,0,0.3); text-align: right; margin-top: 2px; }
        ...
        .chat-input-pill { flex: 1; border: none; background: #f0f2f5; padding: 14px 20px; border-radius: 25px; outline: none; font-size: 1rem; color: #333 !important; font-weight: 500; }
        ...
        @media (max-width: 600px) {
          .chat-footer-full { padding: 12px 15px 20px; }
          .chat-input-pill { padding: 12px 15px; font-size: 0.95rem; }
