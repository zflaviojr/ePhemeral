    ...
    <div className="edit-profile-container">
      <header className="edit-header glass-panel rounded-header shadow-glow">
        ...
        <div className="header-title-wrapper">
          <h2 className="title-main-color">{t('profile.edit_profile')}</h2>
        </div>
      ...
      <form className="edit-content" onSubmit={handleSubmit}>
        ...
        <Card className="form-card">
          <div className="form-group">
            <label className="label-main-color">{t('auth.name')}</label>
            <input 
          ...
          <div className="form-group">
            <label className="label-main-color">{t('auth.welcome_msg')}</label>
            <textarea 
              className="input-base"
